...
// Host stream for protocol responses (Serial or WiFi WebSocket). See protocol.h.
...
void setup() {
  ...
  if (strlen(WIFI_SSID) > 0) {
    Serial.println("WiFi AP: " WIFI_SSID " -> connect app to ws://192.168.4.1:8765");
  }
